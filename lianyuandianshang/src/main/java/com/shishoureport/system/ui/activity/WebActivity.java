...
public class WebActivity extends Activity {
    ...
    //1、http://ht.smiecp.com:8101/lianyuan/wap/index.shtml
//            2、http://ht.smiecp.com:8101/lianyuan/wap/product/index.shtml
//            3、http://ht.smiecp.com:8101/lianyuan/wap/dspx/index.shtml
//            4、http://ht.smiecp.com:8101/lianyuan/wap/map.shtml
//            5、http://ht.smiecp.com:8101/lianyuan/wap/member/index.shtml
    @Override
    public void onBackPressed() {
        if (webView != null && webView.canGoBack()
                && !"http://ht.smiecp.com:8101/rb/member/index.shtml".equals(webView.getUrl())
                && !"http://ht.smiecp.com:8101/rb/index.shtml".equals(webView.getUrl())) {
            webView.goBack();
        } else {
            super.onBackPressed();
        }
