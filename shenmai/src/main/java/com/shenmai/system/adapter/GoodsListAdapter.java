 ...
 * 商品List显示适配器
 */
public class GoodsListAdapter extends AbsBaseAdapter<GoodsEntity> {
    ...
    public GoodsListAdapter(List<GoodsEntity> branchInfos, Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_list_goods, null);
            holder = new ViewHolder();
            holder.tv_goods_name = (TextView) convertView
                    .findViewById(R.id.tv_item_list_goodname);
            holder.tv_goods_type = (TextView) convertView
                    .findViewById(R.id.tv_item_list_goodtype);
            holder.tv_goods_des = (TextView) convertView
                    .findViewById(R.id.tv_item_list_gooddes);
            holder.tv_goods_price = (TextView) convertView
                    .findViewById(R.id.tv_item_list_goodprice);
            holder.tv_goods_reback = (TextView) convertView
                    .findViewById(R.id.tv_item_list_goodreback);
            holder.tv_goods_state = (TextView) convertView
                    .findViewById(R.id.tv_item_list_goodstate);
            holder.img_add_shop = (ImageView) convertView
                    .findViewById(R.id.img_item_list_addshop);
            holder.img_goods_img = (ImageView) convertView
                    .findViewById(R.id.img_item_list_goodimg);
        ...
        holder.tv_goods_type.setText(goodsEntity.comm_no);
        holder.tv_goods_des.setText(goodsEntity.sub_name);
    ...
    private class ViewHolder {
        TextView tv_goods_name, tv_goods_type, tv_goods_des, tv_goods_price,tv_goods_reback,tv_goods_state;
