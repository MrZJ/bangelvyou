...
import com.basulvyou.system.api.CartApi;
import com.basulvyou.system.api.FocusApi;
import com.basulvyou.system.api.ShopDetailApi;
import com.basulvyou.system.entity.CanBuyEntity;
import com.basulvyou.system.entity.CommentInfoEntity;
import com.basulvyou.system.entity.EntpInfoEntity;
import com.basulvyou.system.entity.GoodsCanBuyEntity;
import com.basulvyou.system.entity.GoodsDetailAttrEntity;
import com.basulvyou.system.entity.GoodsDetailAttrInfoEntity;
import com.basulvyou.system.entity.GoodsDetailEntity;
import com.basulvyou.system.entity.GoodsDetailImgEntity;
import com.basulvyou.system.entity.GoodsDetailInfoEntity;
...
//        showLoadingDialog();
    ...
    private void initView() {
        ...
        tab_1 = findViewById(R.id.view_goods_detail_collect);
        ...
        goodInfo = findViewById(R.id.rel_goods_detail_goodsdetail);
        chosenColorClass = findViewById(R.id.rel_goods_detail_goodsclass);
        goodComment = findViewById(R.id.rel_goods_detail_comments);
        commentedNum = (TextView) findViewById(R.id.tv_goods_detail_commentsnum);
        commentLine = findViewById(R.id.view_goods_detail_havecomment);
        ...
        lin_into_class = findViewById(R.id.lin_into_class);
        lin_into_shop = findViewById(R.id.lin_into_shop);
        ...
        LinearLayoutAddress = choseView.findViewById(R.id.ll_chose_address);
    ...
    private void setData() {
        if (detail != null) {
            ...
            if (!StringUtil.isEmpty(configEntity.kuaiAddressCode)) {
...
//            showLoadingDialog();
    ...
    private void setShareNameAndImg(){
        if(shareClickListener != null){
            if(null != detail){
                if(!ListUtils.isEmpty(detail.comm_image_url)){
...
//                }
    ...
    private void goodInvAndPriceHander(String json) {
        if (!StringUtil.isEmpty(json) && !"{}".equals(json.trim())) {
