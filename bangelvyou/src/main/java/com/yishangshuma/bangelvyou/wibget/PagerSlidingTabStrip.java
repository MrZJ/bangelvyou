 ...
 * Created by KevinLi on 2016/2/1.
 */
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicatorPaddingTopBottom = 10;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorPaddingTopBottom = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, indicatorPaddingTopBottom, dm);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(lineLeft + indicatorPaddingTopBottom, height - indicatorHeight
                , lineRight - indicatorPaddingTopBottom, height, rectPaint);
