...
public class LocationApi {
    ...
    public static final String ACTION_GET_NEWS = "/AppLocalInfoList!list.do?";
    public static final String ACTION_GET_NEWS_KEY = "/AppLocalInfoSearch!search.do?";
     ...
     * @return
     */
    public static String getNewsUrl(String page, String curPage, String keyword,String orderkey,String fwz){
        if(keyword == null){
            url = String.format(ACTION_GET_NEWS);
        } else {
            url = String.format(ACTION_GET_NEWS_KEY);
        }
        StringBuffer urlBuffer = new StringBuffer(ConfigUtil.NEWS_HTTP);
        urlBuffer.append(url).append("pager.pageSize=")
                .append(page).append("&pager.requestPage=").append(curPage);
        ...
        if(fwz != null && !"null".equals(fwz)){
            urlBuffer.append("&is_material=").append(fwz);
        }
    ...
    public static String getVirtualShopListUrl(String key, String page,
        ...
        urlBuffer.append(url).append("&key=").append(key).append("&page=")
     ...
     * @return
     */
    public static String getVirtualShopDetailUrl(String comm_id, String udid){
