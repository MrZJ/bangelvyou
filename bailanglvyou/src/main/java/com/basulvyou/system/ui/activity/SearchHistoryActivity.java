...
import com.basulvyou.system.util.JsonParser;
...
public class SearchHistoryActivity extends BaseActivity implements View.OnClickListener {
    ...
    private View voiceSearchView;

    private static String TAG = SearchHistoryActivity.class.getSimpleName();
    // 语音听写对象
    ...
    private void initView() {
        ...
        voiceSearchView = findViewById(R.id.img_top_search);
    ...
    private void initVoiceInput() {
        ...
        mIat = SpeechRecognizer.createRecognizer(SearchHistoryActivity.this, mInitListener);

        // 初始化听写Dialog，如果只使用有UI听写功能，无需创建SpeechRecognizer
        // 使用UI听写功能，请根据sdk文件目录下的notice.txt,放置布局文件和图片资源
        mIatDialog = new RecognizerDialog(SearchHistoryActivity.this, mInitListener);
    ...
    private void printResult(RecognizerResult results) {
        ...
        if (top_title_search != null) {
            top_title_search.setText(resultBuffer);
        }
    }
