...
public class MainActivity extends BaseActivity {
    ...
    private void initFragment() {
        ...
        transaction.add(R.id.fl_body, marketFragment, "marketFragment");
        transaction.add(R.id.fl_body, shopingCarFragment, "shopingCarFragment");
    ...
    public void SwitchTo(int position) {
        ...
        switch (position) {
            ...
            case 0:
                ...
                transaction.hide(shopingCarFragment);
            ...
            //日报
            case 2:
                transaction.show(shopingCarFragment);
                shopingCarFragment.onResume();
                transaction.hide(homeFragment);
                transaction.hide(marketFragment);
                transaction.hide(mineFragment);
                transaction.commitAllowingStateLoss();
