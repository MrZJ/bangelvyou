...
public class CountryTownListRequest extends BaseRequest {
    public static final int COUNTRY_TOWN_LIST_REQUEST = 100002;
    private static final String METHOD = "/MInspection.do?method=getInspectionTownVillageList";
    private int curpage;
    String user_id, town_p_name_like;

    public CountryTownListRequest(int curpage, String town_p_name_like, String user_id) {
        super();
