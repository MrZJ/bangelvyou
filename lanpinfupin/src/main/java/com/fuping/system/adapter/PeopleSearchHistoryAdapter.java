...
public class PeopleSearchHistoryAdapter extends BaseAdapter {
    private List<SearchEntity> mData;
    private Context context;

    public PeopleSearchHistoryAdapter(List<SearchEntity> list, Context context) {
    ...
    private void initHolder(ViewHolder holder, SearchEntity entity, final int pos) {
        ...
        holder.name_tv.setText(entity.poorSearch_desc);
