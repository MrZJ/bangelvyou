...
public class ConfigUtil {
    ...
    public static final String HTTP = "http://yjly.smiecp.com";
    ...
    public static final String HTTP_WEB_WEATHER = "http://e.weather.com.cn/d/detail/101271703.shtml";//天气web
    ...
    public static ConfigEntity loadConfig(Context cxt) {
        ...
        if (StringUtil.isEmpty(ConfigUtil.phoneIMEI)) {
            ConfigUtil.phoneIMEI = getPhoneIMEI(cxt);
        }
        return entity;
    }
    ...
    public static String getPhoneIMEI(Context cxt) {
        ...
        return TelephonyMgr.getDeviceId();//获取手机唯一识别码
    }
