...
public class GetOverTimeListRequest2 extends BaseRequest {
    private static final String METHOD = "/mobile/attendanceOvertimeMyself";
    public static final int GET_OVER_TIME_LIST_REQUEST = 100008;
    private int page, pagecount;
    private String id;

    public GetOverTimeListRequest2(String id, int pagecount, int page) {
        super();
        this.page = page;
