...
public class MyNotificationService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.e("MyNotificationService", "message=" + message);
        try {
    ...
    private void showNotification(UMessage msg) {
        ...
        mBuilder.setContentIntent(getClickPendingIntent(this, msg));
        mBuilder.setDeleteIntent(getDismissPendingIntent(this, msg));
