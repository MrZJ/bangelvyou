...
public class ShareClickListener implements OnClickListener{
	...
	private View view;
	private String customText = "#藏东·318#", imageUrl, downLoadUrl;
	...
	private void shareByCheckImgUrl(boolean silent) {
		...
		if (!StringUtil.isEmpty(downLoadUrl)) {
			...
			if(!StringUtil.isEmpty(goodsID)){
				String goodsUrl = "http://60.174.234.249:8103/service/AppEntpInfo.do?id="+goodsID;
