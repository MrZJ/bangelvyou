...
import com.basulvyou.system.adapter.AlbumGridViewAdapter;
import com.basulvyou.system.util.photo.AlbumHelper;
import com.basulvyou.system.util.photo.Bimp;
import com.basulvyou.system.util.photo.ImageBucket;
        ...
        gridImageAdapter.setOnItemClickListener(new AlbumGridViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(final ToggleButton toggleButton,
                ...
                if (isChecked) {
                    ...
                    chooseBt.setVisibility(View.GONE);
                    okButton.setText("完成" + "(" + Bimp.tempSelectBitmap.size() + "/" + num + ")");
                }
                isShowOkBt();
            }
        });
