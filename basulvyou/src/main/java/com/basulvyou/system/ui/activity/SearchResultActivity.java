...
//        locationSave1 = (TextView) locationView.findViewById(R.id.result_location_save1);
    ...
    private void setNewsData(List<LocationEntity> newsList) {
        ...
        imageLoader.displayImage(entity1.location_img.get(0).comm_image_url, newsImage1, AsynImageUtil.getImageOptions(R.mipmap.location_view), null);
        ...
        if (newsList.size() > 1) {
            ...
            imageLoader.displayImage(entity2.location_img.get(0).comm_image_url, newsImage2, AsynImageUtil.getImageOptions(R.mipmap.location_view), null);
    ...
    private void setLocationData(List<LocationEntity> locationList){
            ...
            imageLoader.displayImage(entity1.location_img.get(0).comm_image_url, locationImage1, AsynImageUtil.getImageOptions(R.mipmap.location_view), null);
            ...
            if(locationList.size() > 1){
                ...
                imageLoader.displayImage(entity2.location_img.get(0).comm_image_url, locationImage2, AsynImageUtil.getImageOptions(R.mipmap.location_view), null);
    ...
    private void setSpecialData( List<ShopEntity> shopList){
        ...
        if(!StringUtil.isEmpty(entity1.goods_image_url1)){
            imageLoader.displayImage(entity1.goods_image_url1, specialImage1, AsynImageUtil.getImageOptions(R.mipmap.location_view), null);
        }
       /* if(entity1.goods_image_url.get(0)!=null &&
                !TextUtils.isEmpty(entity1.goods_image_url.get(0).comm_image_url)) {
            imageLoader.displayImage(entity1.goods_image_url.get(0).comm_image_url, specialImage1, AsynImageUtil.getImageOptions(R.mipmap.location_view), null);
        }*/
        ...
        if(shopList.size() > 1){
            ...
            if(!StringUtil.isEmpty(entity2.goods_image_url1)){
                imageLoader.displayImage(entity2.goods_image_url1, specialImage2, AsynImageUtil.getImageOptions(R.mipmap.location_view), null);
            }
            /*if(entity2.goods_image_url.get(0)!=null &&
                    !TextUtils.isEmpty(entity2.goods_image_url.get(0).comm_image_url)) {
                imageLoader.displayImage(entity2.goods_image_url.get(0).comm_image_url, specialImage2, AsynImageUtil.getImageOptions(R.mipmap.location_view), null);
            }*/
...
//        httpGetRequest(LocationApi.getNewsUrl("2", "0", keyWord, null), LocationApi.API_GET_NEWS_LIST);
