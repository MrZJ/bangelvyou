...
import com.handmark.pulltorefresh.library.internal.CustomAnimLoadingLayout;
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				...
				case CUSTOM:
					...
					case PULL_FROM_START:
					default:
						return new CustomAnimLoadingLayout(context, mode, scrollDirection, attrs);
					case PULL_FROM_END:
						return new RotateLoadingLayout(context, mode, scrollDirection, attrs);
				}
			}
