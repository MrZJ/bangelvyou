...
public class CarpoolingListActivity extends BaseActivity implements View.OnClickListener {
    ...
    public static final String PASSENGER = "102";
    public static final String CAR_OWNER = "101";
    ...
    private void setAdapter() {
        ...
        if (location != null && type != null) {
            ...
            adapter = new CarpoolingFragmentAdapter(getSupportFragmentManager(), list, type);
...
//            adapter.setShopBundle(shopBundleEntity);
            ...
            carpooling_pager.setOffscreenPageLimit(list.size());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_carpooling_list_sendinfo:
                Intent sendIntent = new Intent(this, SendInfomationActivity.class);
