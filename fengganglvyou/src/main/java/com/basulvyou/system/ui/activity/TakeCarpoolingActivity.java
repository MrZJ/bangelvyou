...
public class TakeCarpoolingActivity extends BaseActivity implements View.OnClickListener {
    ...
    private TextView startDate, billNum, tips_tv;
    ...
    private void initView() {
        ...
        if (!StringUtil.isEmpty(photo)) {
            imageLoader.displayImage(photo, carOwnerImg);
        }
        ...
        if (commType.equals("104")) {
            ...
            tips_tv.setText("下单后请电话确认货物发出时间与地点");
    ...
    private void checkEdit() {
        if (StringUtil.isEmpty(edtTel.getText().toString().trim())) {
            ...
            return;
        } else if (!PhoneFormatCheckUtils.isPhoneLegal(edtTel.getText().toString().trim())) {
