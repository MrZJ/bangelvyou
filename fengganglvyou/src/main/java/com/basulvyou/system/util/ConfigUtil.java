...
//    public static final String HTTP = "http://220.178.14.5:8420";//熊丹尼测试地址
//        public static final String HTTP = "http://192.168.3.236:8047";//李加辉测试地址
//    public static final String HTTP = "http://192.168.3.132:8080/mmt_fglv";//李加辉测试地址
    public static final String HTTP = "http://112.29.133.183:8096";//外网地址
//    public static final String HTTP = "http://192.168.3.57:8080";//王亚丽地址
//    public static final String HTTP = "http://192.168.3.54:8080/mmt_bglv";//钱俊测试地址
//    public static final String HTTP = "http://192.168.3.132:8080/mmt_bglv";//李加辉测试地址
    ...
    public static final String HTTP_WEB_WEATHER = "http://e.weather.com.cn/d/index/101140217.shtml";//天气web
    ...
    public static final String HTTP_FENG_GANG_DETAIL = HTTP_URL + "/AppEntpInfo.do?method=viewNewsDetailsOther&mod_id=";//
    ...
    public static ConfigEntity loadConfig(Context cxt) {
        ...
        entity.credit_score = share.getString("credit_score", "");
        entity.mobile = share.getString("mobile", "");
        entity.birthday = share.getString("birthday", "");
        entity.sex = share.getString("sex", "");
        entity.real_name = share.getString("real_name", "");
    ...
    public static void saveConfig(Context cxt, ConfigEntity entity) {
        ...
        editor.putString("credit_score", entity.credit_score);
        editor.putString("mobile", entity.mobile);
        editor.putString("birthday", entity.birthday);
        editor.putString("real_name", entity.real_name);
        editor.putString("sex", entity.sex);
        editor.commit();
    }
