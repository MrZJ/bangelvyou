...
public class SearchFragment extends BaseFragment implements View.OnKeyListener, View.OnClickListener {
...
//        setTopTitle("搜索");
    ...
    private void setData() {
        ...
        Log.e("HTTP_MARKET_URL", ConfigUtil.HTTP_SEARCH_URL);
        webView.loadUrl(ConfigUtil.HTTP_SEARCH_URL);
        webView.setWebChromeClient(new MyWebChromeClient(webPro));
        webView.setWebViewClient(new MyWebViewClient(titleMap, ConfigUtil.HTTP_SEARCH_URL, this));
