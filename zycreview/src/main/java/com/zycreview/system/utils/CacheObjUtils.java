...
public class CacheObjUtils {
    ...
    public static void saveObj(Context context, String key, Object value) throws IOException {
    ...
    public static Object getObj(Context context, String key) throws StreamCorruptedException, IOException, ClassNotFoundException {
        SharedPreferences sp = context.getSharedPreferences("ConfigPerference",
                Context.MODE_PRIVATE);
    ...
    public static void clearObj(Context context,String key){
        SharedPreferences sp = context.getSharedPreferences("ConfigPerference",
                Context.MODE_PRIVATE);
