 ...
 * 入库记录
 */
public class InstockRecordActivity extends AbsLoadMoreActivity<ListView,MedicInstockEntity> implements View.OnClickListener,OnDateSetListener,MedicinalInstockAdapter.OnInstockClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instock_record);
        initView();
        setAdapter();
        initListener();
        loadData();
    ...
    private void initView(){
        initTopView();
        setTitle("入库记录");
        mPullToRefreshListView = (PullToRefreshListView) findViewById(R.id.instock_record_list);
    ...
    private void setAdapter(){
        ...
        ((MedicinalInstockAdapter)mAdapter).setShowType("record");
    }
    ...
    protected void loadData() {
        httpGetRequest(StockApi.getInstockRecordList(configEntity.key, mPager.getPage() + "", Pager.rows + "", keyWord, startDateString, endDateString), StockApi.API_INSTOCK_RECORD_LIST);
    }
    ...
    protected void httpResponse(String json, int action) {
        ...
        switch (action){
            case StockApi.API_INSTOCK_RECORD_LIST:
                recodeHander(json);
                break;
        }
    }
    ...
    private void recodeHander(String json){
