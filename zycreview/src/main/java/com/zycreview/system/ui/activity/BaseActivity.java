...
import com.zycreview.system.UIApplication;
...
import com.zycreview.system.listener.TopBarClickListener;
import com.zycreview.system.utils.AppManager;
...
import com.zycreview.system.utils.OpenApkfile;
import com.zycreview.system.utils.StatusBarUtil;
import com.zycreview.system.utils.StringUtil;
import com.zycreview.system.utils.WifiNetworkUtil;
...
//
     ...
     * 初始化时间选择器
     */
    public void initViewDateDialog(OnDateSetListener listener) {
        dialog = new TimePickerDialog.Builder()
                ...
                .setMinuteText("分")
                .setCyclic(true)
                .setMinMillseconds(System.currentTimeMillis() - ConfigUtil.TenYears)
                .setMaxMillseconds(System.currentTimeMillis() + ConfigUtil.TenYears)
                .setCurrentMillseconds(System.currentTimeMillis())
                .setThemeColor(getResources().getColor(R.color.top_bar_color))
                .setType(Type.YEAR_MONTH_DAY)
                .setWheelItemTextNormalColor(getResources().getColor(R.color.main_text_color_nomal))
                .setWheelItemTextSelectorColor(getResources().getColor(R.color.main_text_color_select))
...
//        top_title_search.setLayoutParams(params);
     ...
     * 设置顶部导航栏监听
     */
    public void initSideBarListener(int tag) {
        btn_top_goback.setOnClickListener(topBarClickListener);
        top_right_title.setOnClickListener(topBarClickListener);
        top_right_title.setTag(tag);
    }
