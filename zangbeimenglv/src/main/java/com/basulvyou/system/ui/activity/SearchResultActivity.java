...
//        locationSave1 = (TextView) locationView.findViewById(R.id.result_location_save1);
    ...
    private void setSpecialData( List<SearchShopEntity> shopList){
       ...
       /* if(entity1.goods_image_url1.get(0)!=null &&
            ...
            imageLoader.displayImage(entity1.goods_image_url1.get(0).comm_image_url, specialImage1, AsynImageUtil.getImageOptions(R.mipmap.location_view), null);
        }*/
        ...
        if(shopList.size() > 1){
            ...
            /*if(entity2.goods_image_url1.get(0)!=null &&
                ...
                imageLoader.displayImage(entity2.goods_image_url1.get(0).comm_image_url, specialImage2, AsynImageUtil.getImageOptions(R.mipmap.location_view), null);
            }*/
