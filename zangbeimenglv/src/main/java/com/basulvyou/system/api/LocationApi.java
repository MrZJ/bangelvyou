...
public class LocationApi {
    ...
    public static final String ACTION_SEARCH_NERABY = "/Service.do?method=getMoreVirtualCommListForLocation&op=more_virtual_comm_list_for_location";
     ...
     * @return
     */
    public static String getNewsUrl(String page, String curPage, String keyword, String orderkey, String mod_id) {
        ...
        if (mod_id != null) {
            urlBuffer.append("&mod_id=").append(mod_id);
        }
     ...
     * @return
     */
    public static String getNearbyUrl(String page, String curPage, double latitude, double longitude, String cls_id) {
        StringBuilder stringBuilder = new StringBuilder(ConfigUtil.HTTP_URL);
        stringBuilder.append(ACTION_SEARCH_NERABY).append("&location=").append(longitude).append(",").
                append(latitude).append("&cls_id=").append(cls_id).append("&curpage=").
